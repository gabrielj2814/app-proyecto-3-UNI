                ...
                <div className="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 columna-sub-menu">
                    ...
                    {modulo[1]==="configuracion"&&
                        <div id="configuracion">
                            ...
                            <span className="item-sub-menu">Medico</span>

                            <span className="item-sub-menu">Estado</span>
                            <span className="item-sub-menu">Ciudad</span>
                            <span className="item-sub-menu">Tipo de Centro Asistencia Medica</span>
                            <span className="item-sub-menu">Centro de Asistencia Medica</span>
                            
                            <span className="item-sub-menu">Reposo</span>
                        </div>
                    }
                    {modulo[1]==="seguridad"&&
                        <div id="seguridad">
